...
- Integrating JS is more complex and we do not benefit from bundle splitting offered by webpack in Express and NextJS' in built support
...
The file can then be included an the serverside response via the `toString()` api as is shown on [this PR](https://github.com/bbc/simorgh/pull/12360/files#diff-7740db73fb905cc3cb804a52fc779531d18dab5bd04724335dd5237481149defR30); the inline script can be transpiled at build time ensuring the transpiled JS is included in the page response appropriately.
