...
describe('constructPageFetchUrl', () => {
  ...
  it.each`
    ...
    ${ARTICLE_PAGE}    | ${'hausa'}      | ${null}   | ${'local'}  | ${'/hausa/news/2010/10/101020_majalisa_shugabankasa'} | ${'http://localhost/api/local/hausa/cpsAssets/hausa/news/2010/10/101020_majalisa_shugabankasa'}
