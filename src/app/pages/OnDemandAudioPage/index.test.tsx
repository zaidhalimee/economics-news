...
import gahuzaOnDemandAudioEpisode from '#data/gahuza/bbc_gahuza_radio/audioepisode.json';
import gahuzaPodcastPage from '#data/gahuza/bbc_gahuza_radio/podcast.json';
import pashtoOnDemandAudio from '#data/pashto/bbc_pashto_radio/audio.json';
import indonesianOnDemandAudio from '#data/indonesia/bbc_indonesian_radio/audio.json';
import swahiliExpiredOnDemandAudio from '#data/swahili/bbc_swahili_radio/expiredaudio.json';
import koreanOnDemandAudio from '#data/korean/bbc_korean_radio/audio.json';
import zhongwenOnDemandAudio from '#data/zhongwen/bbc_cantonese_radio/audio.json';
